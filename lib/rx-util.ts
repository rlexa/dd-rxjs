...
export const rxComplete = (...subjects: Array<Subject<any>>) =>
  subjects
...
export const rxFire = (...subjects: Array<Subject<unknown>>) => subjects.forEach(ii => ii.next());
/** rxFire curry */
export const rxFire_ = (...subjects: Array<Subject<unknown>>) => () => rxFire(...subjects);
